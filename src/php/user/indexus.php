...
<nav class="bg-red-400 fixed w-full z-20 top-0 start-0 p-4 shadow-md rounded-b-4xl">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="indexus.php" class="flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <span class="self-center text-xl text-heading font-semibold whitespace-nowrap">SCRC</span>
        </a>
